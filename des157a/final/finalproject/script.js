(function() {
    ...
    document.getElementById('pic').style.margin = "50px 0px 70px 100px";
    ...
    document.getElementById('pic2').style.margin = "70px 0px 70px 100px";
    document.getElementById('pic3').style.margin = "";
    ...
    document.getElementById('pic3').style.margin = "70px 0px 100px 100px";
    document.getElementById('pic').style.margin = "";
    document.getElementById('pic2').style.margin = "";
